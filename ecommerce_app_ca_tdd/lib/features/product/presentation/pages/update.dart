                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Image(image:NetworkImage(widget.product.imagePath),fit: BoxFit.cover,),
                    ),
                  ),
                            ...
                            children: [
                              SizedBox(
                                ...
                                BlocListener<UpdateBloc, UpdateState>(
                                  listener: (context, state) {
                                    if (state is UpdateSuccess) {
                                      // ScaffoldMessenger.of(context,s).snackbar('Success', 'Product Updated Successfully');
                                ...
                                child: OutlinedButton(
                                  ...
                                  child: Text("Cancel",style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w500))),
                              ),
                            ],
                          ),
                        ),
