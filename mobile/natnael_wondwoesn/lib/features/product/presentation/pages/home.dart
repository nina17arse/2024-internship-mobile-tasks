                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              ...
                              child: Column(
                                children: state.products.map((prd) => OverflowCard(product: prd)).toList(),
                              ),
                            );
                          },
                        ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [Text(product.name,style: GoogleFonts.poppins(fontSize: 20.0,fontWeight: FontWeight.w500,),),
                          SizedBox(height: 8.0),
                  Text(product.description,style: GoogleFonts.poppins(fontSize: 12.0,fontWeight: FontWeight.w400,color: Color.fromRGBO(217, 217, 217, 1))),
                    ],
                  ),
                SizedBox(height: 8.0),
                  Column(
