...
import 'package:flutter_application_5/core/errors/failure/failures.dart' as _i6;
...
class MockProductRepository extends _i1.Mock implements _i4.ProductRepository {
  ...
  @override
  _i5.Future<_i2.Either<_i6.Failure, String>> addProduct(
    String? name,
    String? description,
    double? price,
    String? imagePath,
  ...
  @override
  _i5.Future<_i2.Either<_i6.Failure, String>> deleteProduct(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteProduct,
          [id],
